...
2. **Details Tab:**
   ...
   ![Proxy Host Configuration](./images/proxy_host.png)
...
location / {
    ...
    proxy_set_header Referer https://$server/ipa/ui;
    ...
    proxy_cookie_domain $server $host;
...
![Advanced Configuration](./images/proxy_host.png)
